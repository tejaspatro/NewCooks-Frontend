...
import userPlaceHolderImg from "../../images/Profile_avatar_placeholder_large.png";
import "../chef/Homepage/homepage.css";
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
import Slider from "react-slick";
import { BarChart, Bar, XAxis, YAxis, Tooltip, ResponsiveContainer, CartesianGrid } from "recharts";
import { FaBookOpen, FaStar, FaHeart } from "react-icons/fa";
  ...
  return (
    <>
      ...
      <section className={`${darkMode ? "dark-mode" : ""} position-relative vh-100 w-100 d-flex align-items-center justify-content-center text-center overflow-hidden hero-section`}>
        ...
        {/* Profile Picture (top-right corner) - only for logged-in users */}

        {userData && (<a href="/user/userprofile" className="position-absolute top-0 end-0 m-3 animate-fadeIn">
          <img
            src={userData?.profilePicture || userPlaceHolderImg}
            alt="Profile"
        ...
        <div key={animationKey} className="position-relative z-1 px-3 animate-fadeIn container-fluid">
          <h1 className="display-3 fw-bold text-white lh-tight text-shadow">
            Welcome to <span className="text-danger">NewCooks</span>
          </h1>
          <p className="mt-3 fs-5 text-light">
            Start your cooking Journey. Make cooking easy and fun!
          </p>
      ...
      {/* Discover and Most Viewed Recipes Section */}
      ...
      <section className={`chef-analytics-section py-5 ${darkMode ? "analytics-bg-dark" : "analytics-bg-light"}`}>
        <h2 className="text-center mb-5 " style={{ color: darkMode ? "#00ffffff" : "#0011ffff", textShadow: "2px 2px 8px rgba(0,0,0,0.5)", }}><u> {role === "user" ? "Your Analytics" : "Analytics"} </u></h2>
        ...
        <div className="row justify-content-center g-4 mb-5">
          <div className="col-md-3">
            <div className="analytics-card p-4 text-center shadow rounded bg-gradient-primary text-white">
              ...
              <h3 className="display-4">{analytics?.totalRecipesTried ?? 0}</h3>
              <p>Recipes Tried</p>
            </div>
          </div>
          ...
          <div className="col-md-3">
            <div className="analytics-card p-4 text-center shadow rounded bg-gradient-warning text-white">
              ...
              <h3 className="display-4">{analytics?.totalFavoritesAdded ?? 0}</h3>
              <p>Favorites Added</p>
            </div>
          </div>
          ...
          <div className="col-md-3">
            <div className="analytics-card p-4 text-center shadow rounded bg-gradient-danger text-white">
              ...
              <h3 className="display-4">{analytics?.totalRatingsGiven ?? 0}</h3>
              <p>Ratings Given</p>
            </div>
          </div>
        </div>
          ...
          <div className="row justify-content-center g-4">
            ...
            <div className="col-md-4">
              <div className="help-card p-4 rounded-4 shadow-sm h-100 d-flex flex-column justify-content-center">
                ...
                <Link to="/help#user-guide" className="btn btn-primary mt-auto help-btn">View Guide</Link>
              </div>
            </div>
